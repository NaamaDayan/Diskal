...
PRODUCTS_DATA_COLUMNS = [PRODUCT_ID, PRODUCT_NAME, MANUFACTURER, FAMILY_NAME, OPENING_QUANTITY, GENERAL_BUYS, GENERAL_SALES, EXAMINED_SALES,
                   INVENTORY,
                   LAST_PRICE,
